...
#ifndef H_WEATHER_PROPERTIES_SCI
#define H_WEATHER_PROPERTIES_SCI
...
namespace weather
{
	...
	///
	class CWeatherProperties : public CSingleton<CGameProperties>
	{
	public:
		...
		///
		CWeatherProperties(const CGameProperties& CGamePropertiesCopy);
...
#endif  H_WEATHER_PROPERTIES_SCI